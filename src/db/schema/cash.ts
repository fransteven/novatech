...
export const cashMovements = pgTable("cash_movements", {
  ...
  sourceType: text("source_type").notNull(), // 'sale_payment' | 'layaway_deposit' | 'expense' | 'import_cost' | 'purchase_payment' | 'refund' | 'shareholder_distribution' | 'transfer' | 'adjustment' | 'opening_balance' | 'creditor_loan' | 'creditor_payment' | 'loan_disbursement' | 'loan_payment' | 'loan_origination_fee'
